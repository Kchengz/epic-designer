<template>
    <div class="epic-demo-header h-64px bg-white px-6 flex items-center justify-between">
        <a class="text-black hover:text-black decoration-none items-center flex"
            href="https://kcz66.gitee.io/epic-designer/" target="_blank">
            <img src="@/assets/logo.png" class="w-22px h-22px" alt="" srcset="">
            <span class="ml-4 font-bold text-16px">EpicDesigner低代码设计器</span>
        </a>

        <div class="flex items-center">
            <a class="mr-6 text-#606266 hover:text-#606266" v-for="(item, index) in links" :key="index"
                :href="item.url">{{ item.title }}</a>
            <Select class="w-140px" v-model:value="selectValue" :options="selectOptions" />
            <Divider type="vertical" class="mx-3" />
            <a class="w-26px" href="https://github.com/Kchengz/epic-designer" target="_blank" rel="noopener"
                data-v-b354ede9="" data-v-82c704e6=""><svg role="img" viewBox="0 0 24 24"
...
const links = [
    {
        title: '文档',
        url: 'https://kcz66.gitee.io/epic-designer/'
    },
    {
        title: '更新日志',
