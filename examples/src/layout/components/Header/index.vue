<template>
    <div class="epic-demo-header h-64px px-6 flex items-center justify-between">
        ...
        <div class="epic-demo-header-right flex items-center">
            <a class="mr-6" v-for="(item, index) in links" :key="index" :href="item.url">{{ item.title }}</a>
            <Select class="w-116px" v-model:value="selectValue" size="small" :options="selectOptions" />
            ...
            <a class="w-26px" href="https://github.com/Kchengz/epic-designer" target="_blank" rel="noopener"
                data-v-b354ede9="" data-v-82c704e6="">
