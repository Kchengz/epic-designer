import { a as wn } from "./_commonjsHelpers.da91e947.js";
import { _ as bt } from "./index.1fa3133f.js";
import { k as be, r as je, d as et, b as Ve, t as Et, s as kt, e as tt, w as Ut, j as sn, C as Kn, B as pn, i as fa, a as qn, c as zt, y as En, f as kn } from "./useConfigInject.fdc04e2e.js";
import { r as oe } from "./_vue_commonjs-external.cdc460b2.js";
import { r as va } from "./raf.f4e1fc4f.js";
import { r as ca } from "./KeyCode.93922cee.js";
import { r as Dn } from "./shallowequal.ae22630f.js";
import { r as An, a as mn, b as Vn, c as jn, d as bn, e as Bn, f as Ln, g as Fn } from "./useMergedState.94fe30d0.js";
import { r as Wn, a as $n, b as Un, c as yn, d as zn, e as Gn, f as Hn, g as Yn } from "./_flatRest.969e6721.js";
import { r as sa } from "./index.8a2670ef.js";
import { r as Dt } from "./vnode.716a0aad.js";
import { r as Xn, a as Zn } from "./useRefs.8c7f5dd6.js";
import { r as Jn } from "./collapseMotion.7799b65c.js";
import { r as Gt } from "./useState.0fa93a30.js";
import { r as Qn } from "./index.704db3ff.js";
import { r as er } from "./isMobile.73c6cf20.js";
import { r as tr } from "./omit.ba8a174d.js";
function ar(t, a) {
  ...
  var a = oe, e = t(je()), u = t(ca()), d = t(et()), n = (0, a.defineComponent)({
    ...
    setup: function(o, s) {
      ...
      return function() {
        ...
        }, [(Z == null ? void 0 : Z()) || ((g = v.removeIcon) === null || g === void 0 ? void 0 : g.call(v)) || "\xD7"])]);
        return M ? M(x) : x;
      };
    }
  });
...
function or() {
  if (wa)
    return aa;
  wa = 1;
  var t = Vn(), a = Wn(), e = $n(), u = jn(), d = ir(), n = mn(), r = 200;
  function o(s, i, f) {
...
function Ht() {
  ...
  var a = t(Et()), e = oe, u = "$$__vc-menu-more__key";
  Se.OVERFLOW_KEY = u;
...
function _n() {
  ...
  var a = oe, e = t(Ve()), u = t(je()), d = t(Et()), n = t(bt.exports), r = kt(), o = t(tt()), s = Ht(), i = at(), f = Dt(), m = t(Xn()), h = t(ca()), c = t(gn()), _ = t(sa()), p = t(Ut()), g = 0, C = function() {
    return {
      id: String,
      role: String,
      disabled: Boolean,
  ...
  var b = (0, a.defineComponent)({
    ...
    setup: function(P, U) {
      ...
      var y = "menu_item_".concat(++g, "_$$_").concat(v), T = (0, s.useInjectKeyPath)(), x = T.parentEventKeys, q = T.parentKeys, O = (0, i.useInjectMenu)(), F = O.prefixCls, H = O.activeKeys, K = O.disabled, I = O.changeActiveKeys, j = O.rtl, R = O.inlineCollapsed, V = O.siderCollapsed, D = O.onItemClick, A = O.selectedKeys, Y = O.registerMenuInfo, re = O.unRegisterMenuInfo, k = (0, i.useInjectFirstLevel)(), Q = (0, a.ref)(!1), he = (0, a.computed)(function() {
        return [].concat((0, d.default)(q.value), [v]);
      }), Ne = {
        eventKey: y,
        key: v,
        parentEventKeys: x,
      ...
      var ce = (0, a.computed)(function() {
        ...
        var z, E = "".concat(F.value, "-item");
        return z = {}, (0, u.default)(z, "".concat(E), !0), (0, u.default)(z, "".concat(E, "-danger"), P.danger), (0, u.default)(z, "".concat(E, "-active"), Q.value), (0, u.default)(z, "".concat(E, "-selected"), ue.value), (0, u.default)(z, "".concat(E, "-disabled"), ce.value), z;
      }), Ie = function(E) {
        return {
          key: v,
          eventKey: y,
        ...
        ce.value || (I(he.value), W("mouseenter", E));
      }, xe = function(E) {
        ce.value || (I([]), W("mouseleave", E));
      }, te = function(E) {
        if (W("keydown", E), E.which === h.default.ENTER) {
          var J = Ie(E);
          W("click", E), D(J);
        }
      }, B = function(E) {
        I(he.value), W("focus", E);
      }, le = function(E, J) {
        var Re = (0, a.createVNode)("span", {
          class: "".concat(F.value, "-title-content")
        }, [J]);
        return (!E || (0, r.isValidElement)(J) && J.type === "span") && J && R.value && k && typeof J == "string" ? (0, a.createVNode)("div", {
      ...
      return function() {
        ...
        if (l)
          return null;
        var se = (z = P.title) !== null && z !== void 0 ? z : (E = L.title) === null || E === void 0 ? void 0 : E.call(L), Me = (0, r.flattenChildren)((J = L.default) === null || J === void 0 ? void 0 : J.call(L)), N = Me.length, w = se;
...
function Cn() {
  if (La)
    return st;
  La = 1;
  var t = be.exports, a = bt.exports;
  Object.defineProperty(st, "__esModule", {
    value: !0
  }), st.subMenuProps = st.default = void 0;
  var e = oe, u = t(je()), d = t(Ve()), n = t(Et()), r = t(bt.exports), o = t(tt()), s = U(Ht()), i = at(), f = kt(), m = t(et()), h = t(gn()), c = t(cr()), _ = t(Pn()), p = t(sr()), g = Dt(), C = t(sa()), b = t(Ut()), S = t(Kn());
  function P(M) {
  ...
  function U(M, l) {
    ...
    for (var x in M)
      if (x !== "default" && Object.prototype.hasOwnProperty.call(M, x)) {
        var q = T ? Object.getOwnPropertyDescriptor(M, x) : null;
        q && (q.get || q.set) ? Object.defineProperty(y, x, q) : y[x] = M[x];
      }
  ...
  var Z = (0, e.defineComponent)({
    ...
    setup: function(l, v) {
      var y, T, x = v.slots, q = v.attrs, O = v.emit;
      ...
      var Q = (0, i.useInjectMenu)(), he = Q.prefixCls, Ne = Q.activeKeys, ce = Q.disabled, ue = Q.changeActiveKeys, fe = Q.mode, Ie = Q.inlineCollapsed, Pe = Q.antdMenuTheme, Ee = Q.openKeys, xe = Q.overflowDisabled, te = Q.onOpenChange, B = Q.registerMenuInfo, le = Q.unRegisterMenuInfo, Ce = Q.selectedSubMenuKeys, z = Q.expandIcon, E = K != null, J = !F && ((0, i.useInjectForceRender)() || !E);
      (0, i.useProvideForceRender)(J), (F && E || !F && !E || J) && (B(j, k), (0, e.onBeforeUnmount)(function() {
        le(j);
      }));
      ...
      return function() {
        ...
        if (F) {
          var ae;
          return E ? (ae = x.default) === null || ae === void 0 ? void 0 : ae.call(x) : null;
        }
        ...
        return !xe.value && fe.value !== "inline" ? De = function() {
          ...
          default: function() {
            return [(0, e.createVNode)(C.default.Item, (0, d.default)((0, d.default)({
              ...
              role: "none",
              class: (0, m.default)(Te, "".concat(Te, "-").concat(fe.value), q.class, (ye = {}, (0, u.default)(ye, "".concat(Te, "-open"), $.value), (0, u.default)(ye, "".concat(Te, "-active"), ie.value), (0, u.default)(ye, "".concat(Te, "-selected"), ve.value), (0, u.default)(ye, "".concat(Te, "-disabled"), se.value), ye)),
              onMouseenter: ge,
              onMouseleave: ee,
              "data-submenu-id": I
            }), {
...
function mr() {
  ...
  var e = oe, u = t(je()), d = t(Ve()), n = t(Et()), r = t(Dn()), o = U(at()), s = t(fa()), i = t(Ut()), f = t(dr()), m = fr(), h = kt(), c = t(sa()), _ = t(_n()), p = t(Cn()), g = t(Mn()), C = Dt(), b = Ht(), S = t(Jn());
  function P(M) {
    if (typeof WeakMap != "function")
      return null;
    var l = /* @__PURE__ */ new WeakMap(), v = /* @__PURE__ */ new WeakMap();
  ...
  var W = [], Z = (0, e.defineComponent)({
    ...
    setup: function(l, v) {
      var y = v.slots, T = v.emit, x = v.attrs, q = (0, s.default)("menu", l), O = q.prefixCls, F = q.direction, H = q.getPrefixCls, K = (0, e.ref)({}), I = (0, e.inject)(m.SiderCollapsedKey, (0, e.ref)(void 0)), j = (0, e.computed)(function() {
      ...
      }, Ee = (0, e.ref)(k.value), xe = (0, e.ref)(!1);
      (0, e.watch)(k, function() {
        Ie.value && (Ee.value = k.value);
      }, {
        immediate: !0
        ...
        Ie.value ? k.value = Ee.value : Pe(W);
      }, {
        immediate: !0
      });
      ...
      return (0, o.default)({
        ...
        var N, w, $ = (0, h.flattenChildren)((N = y.default) === null || N === void 0 ? void 0 : N.call(y)), ve = se.value >= $.length - 1 || ue.value !== "horizontal" || l.disabledOverflow, ie = ue.value !== "horizontal" || l.disabledOverflow ? $ : $.map(function(ge, ee) {
          return (0, e.createVNode)(o.MenuContextProvider, {
            key: ge.key,
...
function _r() {
  ...
  var a = oe, e = t(Ve()), u = t(je()), d = t(qn()), n = t(tt()), r = t(bn()), o = t(gr()), s = Dt(), i = t(et()), f = ["prefixCls", "arrow", "showAction", "overlayStyle", "trigger", "placement", "align", "getPopupContainer", "transitionName", "animation", "overlayClassName"], m = (0, a.defineComponent)({
    compatConfig: {
      MODE: 3
    },
    props: {
    ...
    setup: function(c, _) {
      ...
      return function() {
        var l = c.prefixCls, v = c.arrow, y = c.showAction, T = c.overlayStyle, x = c.trigger, q = c.placement, O = c.align, F = c.getPopupContainer, H = c.transitionName, K = c.animation, I = c.overlayClassName, j = (0, d.default)(c, f);
                ...
                return [R.map(function(te) {
                  ...
                  return (0, e.createVNode)(n.MenuItem, {
                    ...
                    default: function() {
                      ...
                      }, [((B = te.closeIcon) === null || B === void 0 ? void 0 : B.call(te)) || ((le = k.removeIcon) === null || le === void 0 ? void 0 : le.call(k)) || "\xD7"])];
                    }
                  });
                })];
              }
...
function Mr() {
  ...
  function s(i, f) {
    ...
    function O(R) {
      ...
      Y === re ? A = q.value === "x" ? V : D : Y > re ? (A = V, q.value = "x") : (A = D, q.value = "y"), f(-A, -A) && R.preventDefault();
    }
    var F = (0, e.ref)({
      onTouchStart: y,
      onTouchMove: T,
...
function In() {
  if (un)
    return oa;
  un = 1;
  var t = xr(), a = Yn(), e = a(function(u, d) {
    return u == null ? {} : t(u, d);
  });
  return oa = e, oa;
}
...
function Rr() {
  ...
  var a = oe, e = t(Ve()), u = t(je()), d = t(Et()), n = t(zt()), r = nr(), o = t(rr()), s = t(ur()), i = t(Cr()), f = ma(), m = t(Mr()), h = t(Sn()), c = t(tt()), _ = t(Sr()), p = t(Gt()), g = t(va()), C = t(et()), b = t(Qn()), S = En(), P = t(Zn()), U = t(In()), L = {
    width: 0,
    height: 0,
    left: 0,
    top: 0,
  ...
  var Z = (0, a.defineComponent)({
    ...
    setup: function(l, v) {
      var y = v.attrs, T = v.slots, x = (0, f.useInjectTabs)(), q = x.tabs, O = x.prefixCls, F = (0, a.ref)(), H = (0, a.ref)(), K = (0, a.ref)(), I = (0, a.ref)(), j = (0, P.default)(), R = (0, n.default)(j, 2), V = R[0], D = R[1], A = (0, a.computed)(function() {
      ...
      }), Ne = (0, n.default)(he, 2), ce = Ne[0], ue = Ne[1], fe = (0, p.default)(0), Ie = (0, n.default)(fe, 2), Pe = Ie[0], Ee = Ie[1], xe = (0, p.default)(0), te = (0, n.default)(xe, 2), B = te[0], le = te[1], Ce = (0, p.default)(null), z = (0, n.default)(Ce, 2), E = z[0], J = z[1], Re = (0, p.default)(null), se = (0, n.default)(Re, 2), Me = se[0], N = se[1], w = (0, p.default)(0), $ = (0, n.default)(w, 2), ve = $[0], ie = $[1], pe = (0, p.default)(0), ge = (0, n.default)(pe, 2), ee = ge[0], ke = ge[1], Ue = (0, r.useRafState)(/* @__PURE__ */ new Map()), ze = (0, n.default)(Ue, 2), Be = ze[0], gt = ze[1], Je = (0, s.default)(q, Be), _t = (0, a.computed)(function() {
        return "".concat(O.value, "-nav-operations-hidden");
      }), nt = (0, a.ref)(0), rt = (0, a.ref)(0);
      (0, a.watchEffect)(function() {
        A.value ? l.rtl ? (nt.value = 0, rt.value = Math.max(0, Pe.value - E.value)) : (nt.value = Math.min(0, E.value - Pe.value), rt.value = 0) : (nt.value = Math.min(0, Me.value - B.value), rt.value = 0);
      });
      var yt = function(ne) {
      ...
      var ya = function() {
        ...
        if (A.value) {
          var _e = k.value;
          l.rtl ? G.right < k.value ? _e = G.right : G.right + G.width > k.value + E.value && (_e = G.right + G.width - E.value) : G.left < -k.value ? _e = -G.left : G.left + G.width > -k.value + E.value && (_e = -(G.left + G.width - E.value)), ue(0), Q(yt(_e));
        } else {
          var de = ce.value;
      ...
      (0, a.watchEffect)(function() {
        ...
        ["top", "bottom"].includes(l.tabPosition) ? (ne = "width", de = E.value, we = Pe.value, Ke = ve.value, G = l.rtl ? "right" : "left", _e = Math.abs(k.value)) : (ne = "height", de = Me.value, we = Pe.value, Ke = ee.value, G = "top", _e = -ce.value);
        var Ae = de;
        ...
        for (var Ye = 0, qe = lt - 1; qe >= 0; qe -= 1) {
          var $e = ut.get(Ge[qe].key) || L;
          if ($e[G] < _e) {
            Ye = qe + 1;
            break;
          }
      ...
      var Zt = function() {
        ...
        Ee(lt), le(Oe), gt(function() {
          var Fe = /* @__PURE__ */ new Map();
          return q.value.forEach(function(We) {
            var Ye = We.key, qe = D.value.get(Ye), $e = (qe == null ? void 0 : qe.$el) || qe;
            $e && Fe.set(Ye, {
              width: $e.offsetWidth,
        ...
        return [].concat((0, d.default)(q.value.slice(0, Yt.value)), (0, d.default)(q.value.slice(Xt.value + 1)));
      ...
      return (0, a.onBeforeUnmount)(function() {
        ...
        var X, ne = l.id, G = l.animated, _e = l.activeKey, de = l.rtl, we = l.editable, Ke = l.locale, ut = l.tabPosition, Ae = l.tabBarGutter, Ge = l.onTabClick, He = y.class, lt = y.style, Oe = O.value, Fe = !!ha.value.length, We = "".concat(Oe, "-nav-wrap"), Ye, qe, $e, Ca;
        A.value ? de ? (qe = k.value > 0, Ye = k.value + E.value < Pe.value) : (Ye = k.value < 0, qe = -k.value + E.value < Pe.value) : ($e = ce.value < 0, Ca = -ce.value + Me.value < B.value);
        var Vt = {};
        ...
        var Ma = q.value.map(function(Pt, Sa) {
          var Ct = Pt.key;
        ...
        return (0, a.createVNode)("div", {
          ...
          default: function() {
            return [(0, a.createVNode)("div", {
              class: (0, C.default)(We, (X = {}, (0, u.default)(X, "".concat(We, "-ping-left"), Ye), (0, u.default)(X, "".concat(We, "-ping-right"), qe), (0, u.default)(X, "".concat(We, "-ping-top"), $e), (0, u.default)(X, "".concat(We, "-ping-bottom"), Ca), X)),
              ref: F
...
function Kr() {
  ...
  var a = oe, e = t(je()), u = t(bt.exports), d = t(zt()), n = t(Ve()), r = t(Rr()), o = t(Tr()), s = kt(), i = t(fa()), f = t(Gt()), m = t(er()), h = t(Fn()), c = t(et()), _ = t(kn()), p = t(wr()), g = t(Ut()), C = ma(), b = t(In()), S = t(tt()), P = t(tr()), U = 0, L = function() {
    return {
      prefixCls: {
        type: String
      },
    ...
    return l.map(function(v) {
      if ((0, s.isValidElement)(v)) {
        for (var y = (0, n.default)({}, v.props || {}), T = 0, x = Object.entries(y); T < x.length; T++) {
          var q = (0, d.default)(x[T], 2), O = q[0], F = q[1];
  ...
  var Z = (0, a.defineComponent)({
    ...
    setup: function(v, y) {
      ...
      var q = (0, i.default)("tabs", v), O = q.prefixCls, F = q.direction, H = q.size, K = q.rootPrefixCls, I = (0, a.computed)(function() {
        return F.value === "rtl";
      ...
      }), Ie = (0, d.default)(fe, 2), Pe = Ie[0], Ee = Ie[1], xe = (0, a.computed)(function() {
        return D.value && !["left", "right"].includes(v.tabPosition) ? "top" : v.tabPosition;
      });
      (0, a.onMounted)(function() {
        v.id || (Ee("rc-tabs-".concat(process.env.NODE_ENV === "test" ? "test" : U)), U += 1);
      });
      ...
      return (0, C.useProvideTabs)({
        ...
        var B, le = v.id, Ce = v.type, z = v.tabBarGutter, E = v.tabBarStyle, J = v.locale, Re = v.destroyInactiveTabPane, se = v.renderTabBar, Me = se === void 0 ? x.renderTabBar : se, N = v.onTabScroll, w = v.hideAdd, $ = v.centered, ve = {
          id: Pe.value,
          activeKey: k.value,
          animated: j.value,
    ...
    slots: ["tabBarExtraContent", "leftExtra", "rightExtra", "moreIcon", "addIcon", "removeIcon", "renderTabBar"],
    setup: function(v, y) {
      var T = y.attrs, x = y.slots, q = y.emit, O = function(H) {
        q("update:activeKey", H), q("change", H);
      };
      return function() {
...
const Er = /* @__PURE__ */ wn(pa), Jr = /* @__PURE__ */ ar({
  __proto__: null,
  default: Er
}, [pa]);
export {
