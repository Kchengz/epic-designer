...
import { m as Ze } from "./monacoEditor.155cdd76.js";
import "vue";
...
function Wt(e, n, i, r = 0) {
  ...
  for (; ; ) {
    ...
    switch (a && (v -= t), a = t > 0, b) {
      case 1:
        c = O.push(c, 0), g = Ve, u = !1;
        break;
      case 2:
        c = O.pop(c), g = Ve, u = !1;
        break;
      case 3:
        c = O.push(c, 1), g = He, u = !1;
        break;
      case 4:
        c = O.pop(c), g = He, u = !1;
        break;
