 ...
 * @param field 属性路径
 */
export declare function getAttributeValue(field: string, obj?: NodeItem | Record<string, any>): Record<string, any> | undefined;
/**
 * 设置属性值的函数
 ...
 * @param obj 属性路径
 */
export declare function setAttributeValue(value: any, field: string, obj?: NodeItem | Record<string, any>): void;
