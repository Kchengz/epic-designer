...
const ne = /* @__PURE__ */ te(ae), pe = {
  ...
  component: () => import("./datePicker-f8c77f5f.js"),
  defaultSchema: {
    label: "日期选择器",
    type: "date",
...
function Le(n = "zh-cn") {
  switch (ne.locale(n), n.toLowerCase()) {
    case "az-az":
      import("./az-c1672ffa.js").then((e) => e.a);
      break;
    case "bg-bg":
      import("./bg-88834efe.js").then((e) => e.b);
      break;
    case "bn-bd":
      import("./bn-bd-eb33b596.js").then((e) => e.b);
      break;
    case "by-by":
      import("./be-fde22708.js").then((e) => e.b);
      break;
    case "ca-es":
      import("./ca-28db322c.js").then((e) => e.c);
      break;
    case "cs-cz":
      import("./cs-75eed46d.js").then((e) => e.c);
      break;
    case "da-dk":
      import("./da-14945961.js").then((e) => e.d);
      break;
    case "de-de":
      import("./de-9f20f7c3.js").then((e) => e.d);
      break;
    case "el-gr":
      import("./el-d97833a2.js").then((e) => e.e);
      break;
    case "en-gb":
      import("./en-gb-2cdedef4.js").then((e) => e.e);
      break;
    case "en-us":
      import("./en-6caaea1a.js").then((e) => e.e);
      break;
    case "es-es":
      import("./es-88d8d27c.js").then((e) => e.e);
      break;
    case "et-ee":
      import("./et-7e773489.js").then((e) => e.e);
      break;
    case "fa-ir":
      import("./fa-41f01e2a.js").then((e) => e.f);
      break;
    case "fi-fi":
      import("./fi-72d070d7.js").then((e) => e.f);
      break;
    case "fr-ca":
      import("./fr-ca-eaf11f1d.js").then((e) => e.f);
      break;
    case "fr-fr":
      import("./fr-6200a893.js").then((e) => e.f);
      break;
    case "ga-ie":
      import("./ga-cdec0827.js").then((e) => e.g);
      break;
    case "gl-es":
      import("./gl-6952ae96.js").then((e) => e.g);
      break;
    case "he-il":
      import("./he-dc562a46.js").then((e) => e.h);
      break;
    case "hi-in":
      import("./hi-5070d9ca.js").then((e) => e.h);
      break;
    case "hr-hr":
      import("./hr-5aa377e4.js").then((e) => e.h);
      break;
    case "hu-hu":
      import("./hu-e53bd638.js").then((e) => e.h);
      break;
    case "hy-am":
      import("./hy-am-c1c725d1.js").then((e) => e.h);
      break;
    case "id-id":
      import("./id-a66ccd27.js").then((e) => e.i);
      break;
    case "is-is":
      import("./is-6bb293be.js").then((e) => e.i);
      break;
    case "it-it":
      import("./it-d76a4018.js").then((e) => e.i);
      break;
    case "ja-jp":
      import("./ja-46c45a78.js").then((e) => e.j);
      break;
    case "ka-ge":
      import("./ka-7c122fb9.js").then((e) => e.k);
      break;
    case "kk-kz":
      import("./kk-af1f80c5.js").then((e) => e.k);
      break;
    case "km-kh":
      import("./km-c14d936e.js").then((e) => e.k);
      break;
    case "kmr-iq":
      import("./ku-3fb13ca0.js").then((e) => e.k);
      break;
    case "kn-in":
      import("./kn-025943c3.js").then((e) => e.k);
      break;
    case "ko-kr":
      import("./ko-9a278dad.js").then((e) => e.k);
      break;
    case "ku-iq":
      import("./ku-3fb13ca0.js").then((e) => e.k);
      break;
    case "lt-lt":
      import("./lt-517ec4eb.js").then((e) => e.l);
      break;
    case "lv-lv":
      import("./lv-aea993de.js").then((e) => e.l);
      break;
    case "mk-mk":
      import("./mk-a9254602.js").then((e) => e.m);
      break;
    case "ml-in":
      import("./ml-b504d431.js").then((e) => e.m);
      break;
    case "mn-mn":
      import("./mn-a24a7145.js").then((e) => e.m);
      break;
    case "ms-my":
      import("./ms-my-74940fcf.js").then((e) => e.m);
      break;
    case "nb-no":
      import("./nb-ceb7ce6c.js").then((e) => e.n);
      break;
    case "ne-np":
      import("./ne-4e189658.js").then((e) => e.n);
      break;
    case "nl-be":
      import("./nl-be-d02fe77f.js").then((e) => e.n);
      break;
    case "nl-nl":
      import("./nl-4b9090cf.js").then((e) => e.n);
      break;
    case "pl-pl":
      import("./pl-747a58c8.js").then((e) => e.p);
      break;
    case "pt-br":
      import("./pt-br-f535ab9b.js").then((e) => e.p);
      break;
    case "pt-pt":
      import("./pt-618796ce.js").then((e) => e.p);
      break;
    case "ro-ro":
      import("./ro-1c26a758.js").then((e) => e.r);
      break;
    case "ru-ru":
      import("./ru-29c6f0a6.js").then((e) => e.r);
      break;
    case "sk-sk":
      import("./sk-fed8a2df.js").then((e) => e.s);
      break;
    case "sl-si":
      import("./sl-ccb6141d.js").then((e) => e.s);
      break;
    case "sr-rs":
      import("./sr-a1866534.js").then((e) => e.s);
      break;
    case "sv-se":
      import("./sv-f7f78fb6.js").then((e) => e.s);
      break;
    case "ta-in":
      import("./ta-902dba5c.js").then((e) => e.t);
      break;
    case "th-th":
      import("./th-157d958f.js").then((e) => e.t);
      break;
    case "tr-tr":
      import("./tr-8ecec507.js").then((e) => e.t);
      break;
    case "uk-ua":
      import("./uk-b3b1eba3.js").then((e) => e.u);
      break;
    case "ur-pk":
      import("./ur-4181e2b2.js").then((e) => e.u);
      break;
    case "vi-vn":
      import("./vi-b0229864.js").then((e) => e.v);
      break;
    case "zh-cn":
      import("./zh-cn-feeee39a.js").then((e) => e.z);
      break;
    case "zh-hk":
      import("./zh-hk-084fefa7.js").then((e) => e.z);
      break;
    case "zh-tw":
      import("./zh-tw-11e6ad61.js").then((e) => e.z);
      break;
  }
}
export {
