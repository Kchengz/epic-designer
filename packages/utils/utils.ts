...
import KAsyncLoader from '@k-designer/core/packages/components/KAsyncLoader/KAsyncLoader.vue'
 ...
 * @returns
 */
export const loadAsyncComponent = (loader: AsyncComponentLoader<any>): any =>
