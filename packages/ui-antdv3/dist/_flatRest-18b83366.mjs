import { B as zr, C as Kr, e as c, D as Er, E as Nr, A as Vr, F as Hr, j as Gr } from "./index-d3f861e4.mjs";
import { C as Lr, D as Dr, L as wr } from "./useConfigInject-f0dbb416.mjs";
var _, J;
function Cr() {
  if (J)
    return _;
