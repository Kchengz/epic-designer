import { s as yt, g as ne, a as Ie, i as de, r as Ee, e as Me, t as St, o as Qe, n as _t, u as It, f as wt, j as Dt } from "./useConfigInject-f0dbb416.mjs";
import { _ as qe } from "./index-5fc6c346.mjs";
import { r as Ot } from "./DownOutlined-c6420e47.mjs";
import { r as xt, a as Ct } from "./classCallCheck-7491e821.mjs";
import { r as Pt } from "./isMobile-1112823b.mjs";
import { r as qt } from "./raf-09a8b76f.mjs";
import { r as Et } from "./KeyCode-8a26b842.mjs";
import { r as Mt } from "./FormItemContext-f32a9c9f.mjs";
import { r as Vt } from "./vnode-1aa65f32.mjs";
import { r as Bt } from "./omit-d14a337a.mjs";
function Rt(r, f) {
...
function et() {
  ...
  function b(s) {
    return typeof s == "number" ? !Number.isNaN(s) : s ? (
      // Normal type: 11.28
      /^\s*-?\d+(\.\d+)?\s*$/.test(s) || // Pre-number: 1.
      /^\s*-?\d+\.\s*$/.test(s) || // Post-number: .1
      /^\s*-?\.\d+\s*$/.test(s)
    ) : !1;
  }
  return X;
...
function At() {
  ...
  var f = r(xt()), i = r(Ct()), d = r(Ie()), m = et(), b = Ze();
  function s(u) {
  ...
  var l = /* @__PURE__ */ function() {
    ...
    return (0, i.default)(u, [{
      ...
      value: function(t) {
        ...
        var x = Math.max((0, m.getNumberPrecision)(this.number), (0, m.getNumberPrecision)(S));
        return new u(w.toFixed(x));
      }
    }, {
      key: "isEmpty",
      value: function() {
  ...
  var v = /* @__PURE__ */ function() {
    ...
    return (0, i.default)(u, [{
      ...
      value: function(t) {
        ...
        if (S.isInvalidate())
          return this;
        var w = Math.max(this.getDecimalStr().length, S.getDecimalStr().length), x = this.alignDecimal(w), R = S.alignDecimal(w), E = (x + R).toString(), q = (0, m.trimNumber)(E), _ = q.negativeStr, I = q.trimStr, h = "".concat(_).concat(I.padStart(w + 1, "0"));
  ...
  function g(u, n, t) {
    ...
    if (u === "")
      return "";
    var w = (0, m.trimNumber)(u), x = w.negativeStr, R = w.integerStr, E = w.decimalStr, q = "".concat(n).concat(E), _ = "".concat(x).concat(R);
    if (t >= 0) {
      var I = Number(E[t]);
      if (I >= 5 && !S) {
        var h = p(u).add("".concat(x, "0.").concat("0".repeat(t)).concat(10 - I));
        return g(h.toString(), n, t, S);
      }
      return t === 0 ? _ : "".concat(_).concat(n).concat(E.padEnd(t, "0").slice(0, t));
    }
...
function $t() {
  ...
  var f = ne, i = r(Ee()), d = r(Ie()), m = r(Pt()), b = r(Me()), s = 200, l = 600, v = (0, f.defineComponent)({
    compatConfig: {
      MODE: 3
    },
    name: "StepHandler",
    ...
    setup: function(g, u) {
      var n = u.slots, t = u.emit, S = (0, f.ref)(), w = function(E, q) {
        E.preventDefault(), t("step", q);
        function _() {
      ...
      return (0, f.onBeforeUnmount)(function() {
        ...
        if ((0, m.default)())
          return null;
        var R = g.prefixCls, E = g.upDisabled, q = g.downDisabled, _ = "".concat(R, "-handler"), I = (0, b.default)(_, "".concat(_, "-up"), (0, d.default)({}, "".concat(_, "-up-disabled"), E)), h = (0, b.default)(_, "".concat(_, "-down"), (0, d.default)({}, "".concat(_, "-down-disabled"), q)), a = {
          unselectable: "on",
          role: "button",
          onMouseup: x,
          onMouseleave: x
    ...
    function l() {
      if (d.value && b.value && m.value)
        try {
          ...
          (0, r.warning)(!1, "Something warning of cursor restore. Please fire issue about this: ".concat(x.message));
        }
    }
    return [s, l];
  }
...
function Tt() {
  ...
  var i = ne, d = r(Ie()), m = r(Qe()), b = r(_t()), s = r(qe), l = r(Ee()), v = R(At()), p = r($t()), g = et(), u = r(kt()), n = r(Wt()), t = r(Et()), S = r(Me()), w = ["prefixCls", "min", "max", "step", "defaultValue", "value", "disabled", "readonly", "keyboard", "controls", "autofocus", "stringMode", "parser", "formatter", "precision", "decimalSeparator", "onChange", "onInput", "onPressEnter", "onStep", "lazy", "class", "style"];
  function x(h) {
  ...
  var I = (0, i.defineComponent)({
    ...
    setup: function(a, N) {
      ...
      var ue = function(e, y) {
        ...
        var c = a.value;
        return D.value.isInvalidate() && ["string", "number"].includes((0, s.default)(c)) ? Number.isNaN(c) ? "" : c : O(D.value.toString(), !1);
      }();
      H.value = ee;
      function Y(c, e) {
        H.value = O(
      ...
      var A = (0, i.computed)(function() {
        ...
        if (!o.isEmpty() && !y && (o = me(o) || o, V = !0), !a.readonly && !a.disabled && V) {
          ...
          if (Q >= 0 && (o = (0, v.default)((0, v.toFixed)(F, ".", Q))), !o.equals(D.value)) {
            var oe;
            ce(o), (oe = a.onChange) === null || oe === void 0 || oe.call(a, o.isEmpty() ? null : E(a.stringMode, o)), a.value === void 0 && Y(o, y);
          }
          return o;
        }
        return D.value;
        ...
        if (!(e && $.value || !e && ve.value)) {
          ...
          (y = a.onStep) === null || y === void 0 || y.call(a, E(a.stringMode, Q), {
            offset: a.step,
            type: e ? "up" : "down"
...
var tt = ae.inputNumberProps = ut = ae.default = void 0, B = ne, zt = k(It()), M = k(Ie()), Gt = k(Qe()), re = k(Ee()), _e = k(Me()), Lt = k(Ut()), Kt = k(Ot()), rt = er(Tt()), Xt = Mt(), Yt = k(wt()), Jt = Vt(), Qt = k(Bt()), xe = k(Dt()), Ce = k(Ht()), Zt = ["class", "bordered", "readonly", "style", "addonBefore", "addonAfter", "prefix", "valueModifiers"];
function at(r) {
  if (typeof WeakMap != "function")
    return null;
...
var Je = (0, rt.inputNumberProps)(), nt = function() {
  return (0, re.default)((0, re.default)({}, Je), {}, {
    ...
    id: String,
    type: String,
    addonBefore: xe.default.any,
    addonAfter: xe.default.any,
    prefix: xe.default.any,
...
var Pe = (0, B.defineComponent)({
  ...
  setup: function(f, i) {
    ...
    return function() {
      var _, I, h, a, N = (0, re.default)((0, re.default)({}, b), f), C = N.class, U = N.bordered, P = N.readonly, W = N.style, j = N.addonBefore, z = j === void 0 ? (_ = s.addonBefore) === null || _ === void 0 ? void 0 : _.call(s) : j, T = N.addonAfter, G = T === void 0 ? (I = s.addonAfter) === null || I === void 0 ? void 0 : I.call(s) : T, D = N.prefix, ce = D === void 0 ? (h = s.prefix) === null || h === void 0 ? void 0 : h.call(s) : D, ue = N.valueModifiers, ie = ue === void 0 ? {} : ue, H = (0, Gt.default)(N, Zt), O = p.value, ee = g.value, Y = (0, _e.default)((a = {}, (0, M.default)(a, "".concat(O, "-lg"), ee === "large"), (0, M.default)(a, "".concat(O, "-sm"), ee === "small"), (0, M.default)(a, "".concat(O, "-rtl"), u.value === "rtl"), (0, M.default)(a, "".concat(O, "-readonly"), P), (0, M.default)(a, "".concat(O, "-borderless"), !U), a), C), A = (0, B.createVNode)(rt.default, (0, re.default)((0, re.default)({}, (0, Qt.default)(H, ["size", "defaultValue"])), {}, {
        ref: S,
        lazy: !!ie.lazy,
        value: n.value,
        class: Y,
        ...
        upHandler: function() {
          return (0, B.createVNode)(Lt.default, {
            class: "".concat(O, "-handler-up-inner")
          }, null);
        },
        downHandler: function() {
          return (0, B.createVNode)(Kt.default, {
            class: "".concat(O, "-handler-down-inner")
          }, null);
        }
      }), K = (0, Ce.default)(z) || (0, Ce.default)(G);
      if ((0, Ce.default)(ce)) {
        var $, ve = (0, _e.default)("".concat(O, "-affix-wrapper"), ($ = {}, (0, M.default)($, "".concat(O, "-affix-wrapper-focused"), t.value), (0, M.default)($, "".concat(O, "-affix-wrapper-disabled"), f.disabled), (0, M.default)($, "".concat(O, "-affix-wrapper-rtl"), u.value === "rtl"), (0, M.default)($, "".concat(O, "-affix-wrapper-readonly"), P), (0, M.default)($, "".concat(O, "-affix-wrapper-borderless"), !U), (0, M.default)($, "".concat(C), !K && C), $));
        A = (0, B.createVNode)("div", {
          ...
          class: "".concat(O, "-prefix")
        }, [ce]), A]);
      }
      if (K) {
        var J, te = "".concat(O, "-group"), pe = "".concat(te, "-addon"), we = z ? (0, B.createVNode)("div", {
          class: pe
        }, [z]) : null, me = G ? (0, B.createVNode)("div", {
          class: pe
        }, [G]) : null, ge = (0, _e.default)("".concat(O, "-wrapper"), te, (0, M.default)({}, "".concat(te, "-rtl"), u.value === "rtl")), le = (0, _e.default)("".concat(O, "-group-wrapper"), (J = {}, (0, M.default)(J, "".concat(O, "-group-wrapper-sm"), ee === "small"), (0, M.default)(J, "".concat(O, "-group-wrapper-lg"), ee === "large"), (0, M.default)(J, "".concat(O, "-group-wrapper-rtl"), u.value === "rtl"), J), C);
        A = (0, B.createVNode)("div", {
          class: le,
          style: W
        }, [(0, B.createVNode)("div", {
