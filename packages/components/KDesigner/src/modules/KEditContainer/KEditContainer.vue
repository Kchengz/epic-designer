<template>
  <section class="k-edit-container">
    <div class="k-edit-range rounded-md">
      <div
        ref="selectorRef"
        class="item checked absolute transition-all pointer-events-none"
      >
...
import { inject, computed, ref, watch, nextTick, type ComponentPublicInstance } from 'vue'
