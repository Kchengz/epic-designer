...
import xr, { defineComponent as Zt, inject as Ue, shallowRef as on, resolveComponent as kn, unref as _, openBlock as mt, createBlock as pe, mergeProps as an, withCtx as Jt, createVNode as Nt, normalizeProps as De, guardReactiveProps as qe, renderSlot as Gn, createCommentVNode as qn, watch as Or, h as Ir, reactive as Mn, useSlots as _n, provide as Ge, ref as jn, computed as Ke, createElementBlock as Mt, Fragment as dn, renderList as vn, createElementVNode as Lt, toDisplayString as Be, toRaw as Tr, createTextVNode as Cr, isRef as Pr, normalizeClass as tr, withModifiers as Dr, withDirectives as er, vShow as nr } from "vue";
class Ar {
  constructor() {
    Ie(this, "components", {});
...
class Rr {
  ...
  addSchema(e) {
    return e.id = rr(), this.schemaList.push(e);
  }
  addSchemas(e) {
    e.forEach((r) => {
      this.addSchema(r);
...
const or = /* @__PURE__ */ Zt({
  ...
  setup(s) {
    ...
    return i(), (f, c) => {
      const d = kn("KNode", !0);
      return _(t) && !_(u).noInput ? (mt(), pe(_(n), an({ key: 0 }, _(u), {
        name: _(u).field
      }), {
        default: Jt(() => [
          Nt(_(t), De(qe({ ..._(o), ..._(u).componentProps, [_(o).bindModel]: _(r)[_(u).field] })), {
            node: Jt((v) => [
              Nt(d, De(qe(v)), null, 16)
            ]),
            "edit-node": Jt((v) => [
        ...
        _: 3
      }, 16, ["name"])) : _(t) ? (mt(), pe(_(t), De(an({ key: 1 }, { ..._(o), ..._(u).componentProps, [_(o).bindModel]: _(r)[_(u).field] })), {
        node: Jt((v) => [
          Nt(d, De(qe(v)), null, 16)
        ]),
        "edit-node": Jt((v) => [
  ...
  setup(s, { expose: e }) {
    const r = s, { component: a } = ge.getComponent("Form"), n = Mn({}), u = _n();
    Ge("formData", n), Ge("slots", u);
    ...
    return e({
      ...
      default: Jt(() => {
        var d;
        return [
          (mt(!0), Mt(dn, null, vn((d = r.schemas) == null ? void 0 : d.nodes, (v, h) => (mt(), pe(_(or), {
            ref_for: !0,
            ref: "Knode",
            key: h,
            record: v
  ...
  for (const [a, n] of e)
    r[a] = n;
  return r;
}, jr = {}, Fr = { class: "k-header" }, wr = /* @__PURE__ */ Lt("div", { class: "k-header-item" }, " \u64A4\u9500 \u91CD\u505A ", -1), Lr = /* @__PURE__ */ Lt("div", { class: "k-header-item" }, " k-designer ", -1), $r = /* @__PURE__ */ Lt("div", { class: "k-header-item" }, " \u9884\u89C8 \u5173\u95ED ", -1), Ur = [
  wr,
  Lr,
  $r
];
function Gr(s, e) {
  return mt(), Mt("header", Fr, Ur);
}
const Kr = /* @__PURE__ */ ar(jr, [["render", Gr]]), Br = {}, Vr = { class: "k-footer" };
function Hr(s, e) {
  return mt(), Mt("header", Vr, " \u6211\u662F\u5E95\u90E8 ");
}
const Wr = /* @__PURE__ */ ar(Br, [["render", Hr]]);
...
var kt = Qt(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), Ve = Qt(/Edge/i), Bn = Qt(/firefox/i), je = Qt(/safari/i) && !Qt(/chrome/i) && !Qt(/android/i), sr = Qt(/iP(ad|od|hone)/i), ro = Qt(/chrome/i) && Qt(/android/i), lr = {
  capture: !1,
  passive: !1
};
function Z(s, e, r) {
...
function Vt(s, e, r, a) {
  if (s) {
    r = r || document;
    do {
      if (e != null && (e[0] === ">" ? s.parentNode === r && sn(s, e) : sn(s, e)) || a && s === r)
        return s;
      if (s === r)
        break;
    } while (s = oo(s));
...
function wn(s, e) {
  for (var r = s.lastElementChild; r && (r === B.ghost || L(r, "display") === "none" || e && !sn(r, e)); )
...
function vt(s, e) {
  ...
  for (; s = s.previousElementSibling; )
    s.nodeName.toUpperCase() !== "TEMPLATE" && s !== B.clone && (!e || sn(s, e)) && r++;
  return r;
}
function Wn(s) {
  var e = 0, r = 0, a = Xt();
  ...
  return {
    ...
    animateAll: function(a) {
      ...
      s.forEach(function(o) {
        ...
        p && (c.top -= p.f, c.left -= p.e), l.toRect = c, l.thisAnimationDuration && mn(d, c) && !mn(f, c) && (h.top - c.top) / (h.left - c.left) === (f.top - c.top) / (f.left - c.left) && (i = fo(h, d, v, n.options)), mn(c, f) || (l.prevFromRect = f, l.prevToRect = c, i || (i = n.options.animation), n.animate(l, h, c, i)), i && (u = !0, t = Math.max(t, i), clearTimeout(l.animationResetTimer), l.animationResetTimer = setTimeout(function() {
    ...
    animate: function(a, n, u, t) {
      if (t) {
        ...
        a.animatingX = !!f, a.animatingY = !!c, L(a, "transform", "translate3d(" + f + "px," + c + "px,0)"), this.forRepaintDummy = uo(a), L(a, "transition", "transform " + t + "ms" + (this.options.easing ? " " + this.options.easing : "")), L(a, "transform", "translate3d(0,0,0)"), typeof a.animated == "number" && clearTimeout(a.animated), a.animated = setTimeout(function() {
...
var fe = [], Sn = {
  ...
  mount: function(e) {
    for (var r in Sn)
      Sn.hasOwnProperty(r) && !(r in e) && (e[r] = Sn[r]);
...
var co = ["evt"], At = function(e, r) {
  var a = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : {}, n = a.evt, u = Zr(a, co);
...
var A, ct, z, at, se, tn, dt, ee, he, wt, we, te, Ye, Ot, ve = !1, ln = !1, un = [], ae, Kt, bn, En, Yn, zn, Re, ce, Le, $e = !1, ze = !1, en, It, xn = [], Dn = !1, fn = [], hn = typeof document < "u", Je = sr, Jn = Ve || kt ? "cssFloat" : "float", vo = hn && !ro && !sr && "draggable" in document.createElement("div"), dr = function() {
  if (!!hn) {
    if (kt)
      return !1;
...
hn && document.addEventListener("click", function(s) {
  if (ln)
    return s.preventDefault(), s.stopPropagation && s.stopPropagation(), s.stopImmediatePropagation && s.stopImmediatePropagation(), ln = !1, !1;
}, !0);
var ie = function(e) {
  if (A) {
    e = e.touches ? e.touches[0] : e;
    var r = po(e.clientX, e.clientY);
    if (r) {
      var a = {};
      for (var n in e)
...
B.prototype = {
  ...
  _onTapStart: function(e) {
    if (!!e.cancelable) {
      ...
      if (Io(a), !A && !(/mousedown|pointerdown/.test(t) && e.button !== 0 || n.disabled) && !l.isContentEditable && !(!this.nativeDraggable && je && i && i.tagName.toUpperCase() === "SELECT") && (i = Vt(i, n.draggable, a, !1), !(i && i.animated) && tn !== i)) {
  ...
  _prepareDragStart: function(e, r, a) {
    ...
    if (a && !A && a.parentNode === u) {
      var l = it(a);
      if (at = u, A = a, ct = A.parentNode, se = A.nextSibling, tn = a, Ye = t.group, B.dragged = A, ae = {
        target: A,
        clientX: (r || e).clientX,
        clientY: (r || e).clientY
  ...
  _disableDelayedDrag: function() {
    A && On(A), clearTimeout(this._dragStartTimer), this._disableDelayedDragEvents();
  },
  ...
  _triggerDragStart: function(e, r) {
    ...
    try {
      document.selection ? nn(function() {
  ...
  _dragStarted: function(e, r) {
    if (ve = !1, at && A) {
      At("dragStarted", this, {
        evt: r
      }), this.nativeDraggable && Z(document, "dragover", go);
      var a = this.options;
  ...
  _onTouchMove: function(e) {
    if (ae) {
      var r = this.options, a = r.fallbackTolerance, n = r.fallbackOffset, u = e.touches ? e.touches[0] : e, t = z && le(z, !0), o = z && t && t.a, i = z && t && t.d, l = Je && It && Wn(It), f = (u.clientX - ae.clientX + n.x) / (o || 1) + (l ? l[0] - xn[0] : 0) / (o || 1), c = (u.clientY - ae.clientY + n.y) / (i || 1) + (l ? l[1] - xn[1] : 0) / (i || 1);
      if (!B.active && !ve) {
      ...
      if (z) {
        ...
        L(z, "webkitTransform", d), L(z, "mozTransform", d), L(z, "msTransform", d), L(z, "transform", d), bn = f, En = c, Kt = u;
      }
    ...
    if (!z) {
      ...
      if (Je) {
        for (It = e; L(It, "position") === "static" && L(It, "transform") === "none" && It !== document; )
          It = It.parentNode;
        It !== document.body && It !== document.documentElement ? (It === document && (It = Xt()), r.top += It.scrollTop, r.left += It.scrollLeft) : It = Xt(), xn = Wn(It);
      }
  ...
  _onDragStart: function(e, r) {
    ...
    At("setupClone", this), B.eventCanceled || (dt = Ln(A), dt.draggable = !1, dt.style["will-change"] = "", this._hideClone(), lt(dt, this.options.chosenClass, !1), B.clone = dt), a.cloneId = nn(function() {
      At("clone", a), !B.eventCanceled && (a.options.removeCloneOnHide || at.insertBefore(dt, A), a._hideClone(), Pt({
        sortable: a,
        name: "clone"
      }));
    }), !r && lt(A, u.dragClass, !0), r ? (ln = !0, a._loopId = setInterval(a._emulateDragOver, 50)) : (Q(document, "mouseup", a._onDrop), Q(document, "touchend", a._onDrop), Q(document, "touchcancel", a._onDrop), n && (n.effectAllowed = "move", u.setData && u.setData.call(a, n, A)), Z(document, "drop", a), L(A, "transform", "translateZ(0)")), ve = !0, a._dragStartId = nn(a._dragStarted.bind(a, r, e)), Z(document, "selectstart", a), Re = !0, je && L(document.body, "user-select", "none");
  },
  _onDragOver: function(e) {
    ...
    if (A.contains(e.target) || a.animated && a.animatingX && a.animatingY || h._ignoreWhileAnimating === a)
      return b(!1);
    if (ln = !1, l && !o.disabled && (f ? c || (t = ct !== at) : Ot === this || (this.lastPutMode = Ye.checkPull(this, l, A, e)) && i.checkPut(this, l, A, e))) {
      ...
      if (!x || bo(e, v, this) && !x.animated) {
        ...
        u = it(a);
        var O = 0, w, $ = A.parentNode !== r, I = !ho(A.animated && A.toRect || n, a.animated && a.toRect || u, v), N = v ? "top" : "left", j = Hn(a, "top", "top") || Hn(A, "top", "top"), X = j ? j.scrollTop : void 0;
        ce !== a && (w = u[N], $e = !1, ze = !I && o.invertSwap || $), O = Eo(e, a, u, v, I ? 1 : o.swapThreshold, o.invertedSwapThreshold == null ? o.swapThreshold : o.invertedSwapThreshold, ze, ce === a);
        var D;
        if (O !== 0) {
          var R = vt(A);
          do
        ...
        if (G !== !1)
          return (G === 1 || G === -1) && (M = G === 1), Dn = !0, setTimeout(yo, 30), S(), M && !W ? r.appendChild(A) : a.parentNode.insertBefore(A, M ? W : a), j && cr(j, 0, X - j.scrollTop), ct = A.parentNode, w !== void 0 && !ze && (en = Math.abs(w - it(a)[N])), T(), b(!0);
      }
      if (r.contains(A))
        return b(!1);
    }
  ...
  _nulling: function() {
    At("nulling", this), at = A = ct = z = se = dt = tn = ee = ae = Kt = Re = wt = te = he = we = ce = Le = Ot = Ye = B.dragged = B.ghost = B.clone = B.active = null, fn.forEach(function(e) {
      e.checked = !0;
    }), fn.length = bn = En = 0;
  },
  ...
  toArray: function() {
    for (var e = [], r, a = this.el.children, n = 0, u = a.length, t = this.options; n < u; n++)
      r = a[n], Vt(r, t.draggable, this.el, !1) && e.push(r.getAttribute(t.dataIdAttr) || Oo(r));
    return e;
  },
  sort: function(e, r) {
    var a = {}, n = this.el;
...
hn && Z(document, "touchmove", function(s) {
...
function To() {
  ...
  return s.prototype = {
    ...
    drop: function() {
      this.sortable.nativeDraggable ? Q(document, "dragover", this._handleAutoScroll) : (Q(document, "pointermove", this._handleFallbackAutoScroll), Q(document, "touchmove", this._handleFallbackAutoScroll), Q(document, "mousemove", this._handleFallbackAutoScroll)), Qn(), rn(), so();
    },
    nulling: function() {
      cn = Rn = Ne = Nn = Me = In = Tn = null, gt.length = 0;
    },
    ...
    _handleAutoScroll: function(r, a) {
      ...
      if (cn = r, a || this.options.forceAutoScrollFallback || Ve || kt || je) {
        Cn(r, this.options, o, a);
        var i = ne(o, !0);
        Nn && (!Me || u !== In || t !== Tn) && (Me && Qn(), Me = setInterval(function() {
          var l = ne(document.elementFromPoint(u, t), !0);
          l !== i && (i = l, rn()), Cn(r, n.options, l, a);
        }, 10), In = u, Tn = t);
      } else {
  ...
  if (!!e.scroll) {
    ...
    do {
      ...
      (gt[c].vx != X || gt[c].vy != D || gt[c].el !== v) && (gt[c].el = v, gt[c].vx = X, gt[c].vy = D, clearInterval(gt[c].pid), (X != 0 || D != 0) && (l = !0, gt[c].pid = setInterval(function() {
        a && this.layer === 0 && B.active._onTouchMove(cn);
        var W = gt[this.layer].vy ? gt[this.layer].vy * o : 0, M = gt[this.layer].vx ? gt[this.layer].vx * o : 0;
        typeof f == "function" && f.call(B.dragged.parentNode[Tt], M, W, s, cn, gt[this.layer].el) !== "continue" || cr(gt[this.layer].el, M, W);
      }.bind({
        layer: c
      }), 24))), c++;
...
function Co() {
  ...
  return s.prototype = {
    ...
    drop: function(r) {
      ...
      $t && lt($t, o.swapClass, !1), $t && (o.swap || n && n.options.swap) && u !== $t && (t.captureAnimationState(), t !== a && a.captureAnimationState(), Po(u, $t), t.animateAll(), t !== a && a.animateAll());
    },
    nulling: function() {
      $t = null;
    }
    ...
    revert: function(r) {
      ...
      Y.length > 1 && (Y.forEach(function(o) {
        u.addAnimationState({
          target: o,
          rect: Rt ? it(o) : t
        }), yn(o), o.fromRect = t, a.removeAnimationState(o);
      }), Rt = !1, Ao(!this.options.removeCloneOnHide, n));
    },
    dragOverCompleted: function(r) {
...
const Ro = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  Sortable: B,
  Swap: Co
}, Symbol.toStringTag, { value: "Module" })), No = /* @__PURE__ */ zr(Ro);
(function(s, e) {
  (function(a, n) {
    s.exports = n(xr, No);
  })(typeof self < "u" ? self : Xr, function(r, a) {
    return function(n) {
      var u = {};
      function t(o) {
        if (u[o])
...
`) && (I = "(?: " + I + ")", j = " " + j, N++), x = new RegExp("^(?:" + I + ")", $)), h && (x = new RegExp("^" + I + "$(?!\\s)", $)), d && (T = b.lastIndex), C = l.call(w ? x : b, j), w ? C ? (C.input = C.input.slice(N), C[0] = C[0].slice(N), C.index = b.lastIndex, b.lastIndex += C[0].length) : b.lastIndex = 0 : d && C && (b.lastIndex = b.global ? C.index + C[0].length : T), h && C && C.length > 1 && f.call(C[0], x, function() {
      ...
      a4d3: function(n, u, t) {
        var o = t("23e7"), i = t("da84"), l = t("d066"), f = t("c430"), c = t("83ab"), d = t("4930"), v = t("fdbf"), h = t("d039"), p = t("5135"), g = t("e8b5"), S = t("861d"), b = t("825a"), T = t("7b0b"), x = t("fc6a"), C = t("c04e"), O = t("5c6c"), w = t("7c73"), $ = t("df75"), I = t("241c"), N = t("057f"), j = t("7418"), X = t("06cf"), D = t("9bf2"), R = t("d1e7"), W = t("9112"), M = t("6eeb"), G = t("5692"), tt = t("f772"), rt = t("d012"), bt = t("90e3"), ut = t("b622"), ft = t("e538"), yt = t("746f"), St = t("d44e"), pt = t("69f3"), ot = t("b727").forEach, st = tt("hidden"), jt = "Symbol", Ct = "prototype", zt = ut("toPrimitive"), re = pt.set, qt = pt.getterFor(jt), Et = Object[Ct], xt = i.Symbol, oe = l("JSON", "stringify"), Ht = X.f, Wt = D.f, We = N.f, pn = R.f, Gt = G("symbols"), _t = G("op-symbols"), ue = G("string-to-symbol-registry"), ye = G("symbol-to-string-registry"), Se = G("wks"), be = i.QObject, Ee = !be || !be[Ct] || !be[Ct].findChild, xe = c && h(function() {
          ...
          var k = Ht(Et, U);
          k && delete Et[U], Wt(H, U, K), k && H !== Et && Wt(Et, U, k);
        } : Wt, Oe = function(H, U) {
          var K = Gt[H] = w(xt[Ct]);
          return re(K, {
            type: jt,
          ...
          U === Et && m(_t, K, k), b(U);
          var q = C(K, !0);
          return b(k), p(Gt, q) ? (k.enumerable ? (p(U, st) && U[st][q] && (U[st][q] = !1), k = w(k, { enumerable: O(0, !1) })) : (p(U, st) || Wt(U, st, O(1, {})), U[st][q] = !0), xe(U, q, k)) : Wt(U, q, k);
        }, E = function(U, K) {
          b(U);
          var k = x(K), q = $(k).concat(et(k));
          return ot(q, function(Dt) {
            (!c || F.call(k, Dt)) && m(U, Dt, k[Dt]);
          }), U;
        }, P = function(U, K) {
          return K === void 0 ? w(U) : E(w(U), K);
        }, F = function(U) {
          var K = C(U, !0), k = pn.call(this, K);
          return this === Et && p(Gt, K) && !p(_t, K) ? !1 : k || !p(this, K) || !p(Gt, K) || p(this, st) && this[st][K] ? k : !0;
        }, V = function(U, K) {
          var k = x(U), q = C(K, !0);
          if (!(k === Et && p(Gt, q) && !p(_t, q))) {
            var Dt = Ht(k, q);
            return Dt && p(Gt, q) && !(p(k, st) && k[st][q]) && (Dt.enumerable = !0), Dt;
          }
        }, J = function(U) {
          var K = We(x(U)), k = [];
          return ot(K, function(q) {
            !p(Gt, q) && !p(rt, q) && k.push(q);
          }), k;
        }, et = function(U) {
          var K = U === Et, k = We(K ? _t : x(U)), q = [];
          return ot(k, function(Dt) {
            p(Gt, Dt) && (!K || p(Et, Dt)) && q.push(Gt[Dt]);
          }), q;
        };
        if (d || (xt = function() {
          if (this instanceof xt)
            throw TypeError("Symbol is not a constructor");
          var U = !arguments.length || arguments[0] === void 0 ? void 0 : String(arguments[0]), K = bt(U), k = function(q) {
            this === Et && k.call(_t, q), p(this, st) && p(this[st], K) && (this[st][K] = !1), xe(this, K, O(1, q));
          };
          return c && Ee && xe(Et, K, { configurable: !0, set: k }), Oe(K, U);
          ...
          o({ target: "JSON", stat: !0, forced: ht }, {
            stringify: function(U, K, k) {
              for (var q = [U], Dt = 1, gn; arguments.length > Dt; )
                q.push(arguments[Dt++]);
              if (gn = K, !(!S(K) && U === void 0 || y(U)))
                return g(K) || (K = function(Sr, Xe) {
                  if (typeof gn == "function" && (Xe = gn.call(this, Sr, Xe)), !y(Xe))
                    return Xe;
                }), q[1] = K, oe.apply(null, q);
            }
          });
        }
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`);
        ...
        function We(y) {
          ...
          var U = F.flatMap(function(K, k) {
            return H({
              element: K,
              index: k
            }).map(function(q) {
              return q.key = P(K), q.props = d(d({}, q.props || {}), {}, {
                "data-draggable": !0
              }), q;
            });
          });
...
const yr = /* @__PURE__ */ Yr(ir.exports), Mo = { class: "k-component-view" }, jo = { class: "collapse-header" }, Fo = { class: "source-componet-item" }, wo = /* @__PURE__ */ Zt({
  ...
  setup(s) {
    ...
    return (a, n) => (mt(), Mt("aside", Mo, [
      (mt(!0), Mt(dn, null, vn(e.value, (u) => (mt(), Mt("div", null, [
        Lt("div", jo, Be(u.title), 1),
        Nt(_(yr), an({
          modelValue: u.list,
  ...
  setup(s, { emit: e }) {
    ...
    return o(), (l, f) => (mt(), pe(_(u), De(qe({ ..._(t) })), null, 16));
  }
}), $o = { class: "k-right-sidebar" }, Uo = { key: 0 }, Go = /* @__PURE__ */ Zt({
  ...
  setup(s) {
    ...
    return (o, i) => (mt(), Mt("aside", $o, [
      Cr(" \u5C5E\u6027\u9762\u677F "),
      _(a) ? (mt(), Mt("div", Uo, [
        (mt(!0), Mt(dn, null, vn(_(n), (l) => (mt(), Mt("div", {
          key: l.attrIndex
        }, [
...
}), Ko = ["onClick"], Bo = { class: "action-box" }, Vo = { class: "action-item" }, Ho = /* @__PURE__ */ Zt({
  ...
  setup(s, { emit: e }) {
    ...
    return (u, t) => {
      const o = kn("KEditNodeItem", !0);
      return mt(), pe(_(yr), {
        modelValue: _(n),
        "onUpdate:modelValue": t[0] || (t[0] = (i) => Pr(n) ? n.value = i : null),
        ...
        item: Jt(({ element: i }) => {
          ...
          return [
            Lt("div", {
              class: tr(["item", { checked: ((l = _(a).state.checkedNode) == null ? void 0 : l.id) === i.id }]),
              onClick: Dr((c) => _(a).setCheckedNode(i), ["stop"])
            }, [
              er(Lt("div", Bo, [
                Lt("div", Vo, Be(i.type), 1)
              ], 512), [
                [nr, ((f = _(a).state.checkedNode) == null ? void 0 : f.id) === i.id]
              ]),
              Nt(_(or), { record: i }, {
                "edit-node": Jt((c) => [
                  Nt(o, {
                    schemas: i.children,
                    "onUpdate:schemas": (d) => i.children = d
...
}), Wo = { class: "k-edit-container" }, Xo = { class: "k-edit-range" }, Yo = /* @__PURE__ */ Zt({
  __name: "KEditContainer",
  setup(s) {
    const e = Mn({}), r = _n();
    Ge("formData", e), Ge("slots", r);
    const a = jn([{
      title: "\u9875\u9762",
      type: "page",
      id: "page",
    ...
    return (n, u) => (mt(), Mt("section", Wo, [
      Lt("div", Xo, [
        Nt(Ho, {
          schemas: a.value,
          "onUpdate:schemas": u[0] || (u[0] = (t) => a.value = t)
        }, null, 8, ["schemas"])
      ])
    ]));
  }
}), zo = { class: "k-action-bar" }, Jo = { class: "actions-container" }, Qo = ["title", "onClick"], Zo = /* @__PURE__ */ Zt({
  __name: "KActionBar",
  setup(s) {
    ...
    return (n, u) => (mt(), Mt("div", zo, [
      Lt("ul", Jo, [
        (mt(), Mt(dn, null, vn(r, (t, o) => Lt("li", {
          class: tr(["action-item", { checked: _(e).state.actionBarCheckedIndex === o }]),
          title: t,
          onClick: (i) => a(o)
        }, Be(t), 11, Qo)), 64))
      ])
...
}), ko = { class: "k-designer-main" }, qo = { class: "k-split-view-container" }, _o = /* @__PURE__ */ Zt({
  __name: "KDesigner",
  setup(s) {
    const e = Mn({
      checkedNode: null,
    ...
    return (a, n) => (mt(), Mt("div", ko, [
      Nt(Kr),
      Lt("div", qo, [
        Nt(Zo),
        er(Nt(wo, null, null, 512), [
          [nr, e.actionBarCheckedIndex === 0]
        ]),
        Nt(Yo),
        Nt(Go)
      ]),
