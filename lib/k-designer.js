...
var xr = (s, e, r) => e in s ? Er(s, e, { enumerable: !0, configurable: !0, writable: !0, value: r }) : s[e] = r;
var Ie = (s, e, r) => (xr(s, typeof e != "symbol" ? e + "" : e, r), r);
import * as Or from "vue";
import { defineComponent as Zt, inject as Ue, shallowRef as on, resolveComponent as kn, unref as _, openBlock as mt, createBlock as pe, mergeProps as an, withCtx as Jt, createVNode as Nt, normalizeProps as De, guardReactiveProps as qe, renderSlot as Gn, createCommentVNode as qn, watch as Ir, h as Tr, reactive as Mn, useSlots as _n, provide as Ge, ref as jn, computed as Ke, createElementBlock as Mt, Fragment as dn, renderList as vn, createElementVNode as Lt, toDisplayString as Be, toRaw as Cr, createTextVNode as Pr, isRef as Dr, normalizeClass as tr, withModifiers as Ar, withDirectives as er, vShow as nr } from "vue";
class Rr {
  constructor() {
    Ie(this, "components", {});
...
const Br = /* @__PURE__ */ ar(Fr, [["render", Kr]]), Vr = {}, Hr = { class: "k-footer" };
function Wr(s, e) {
  return mt(), Mt("header", Hr, " \u6211\u662F\u5E95\u90E8 ");
}
const Xr = /* @__PURE__ */ ar(Vr, [["render", Wr]]);
...
var kt = Qt(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i), Ve = Qt(/Edge/i), Bn = Qt(/firefox/i), je = Qt(/safari/i) && !Qt(/chrome/i) && !Qt(/android/i), lr = Qt(/iP(ad|od|hone)/i), oo = Qt(/chrome/i) && Qt(/android/i), ur = {
  capture: !1,
  passive: !1
};
function Z(s, e, r) {
  s.addEventListener(e, r, !kt && ur);
}
function Q(s, e, r) {
  s.removeEventListener(e, r, !kt && ur);
}
function sn(s, e) {
  if (!!e) {
  ...
  return {
    ...
    animateAll: function(a) {
      ...
      s.forEach(function(o) {
        ...
        p && (c.top -= p.f, c.left -= p.e), l.toRect = c, l.thisAnimationDuration && mn(d, c) && !mn(f, c) && (h.top - c.top) / (h.left - c.left) === (f.top - c.top) / (f.left - c.left) && (i = co(h, d, v, n.options)), mn(c, f) || (l.prevFromRect = f, l.prevToRect = c, i || (i = n.options.animation), n.animate(l, h, c, i)), i && (u = !0, t = Math.max(t, i), clearTimeout(l.animationResetTimer), l.animationResetTimer = setTimeout(function() {
...
var A, ct, z, at, se, tn, dt, ee, he, wt, we, te, Ye, Ot, ve = !1, ln = !1, un = [], ae, Kt, bn, En, Yn, zn, Re, ce, Le, $e = !1, ze = !1, en, It, xn = [], Dn = !1, fn = [], hn = typeof document < "u", Je = lr, Jn = Ve || kt ? "cssFloat" : "float", ho = hn && !oo && !lr && "draggable" in document.createElement("div"), vr = function() {
  if (!!hn) {
    if (kt)
      return !1;
...
B.prototype = {
  ...
  _onTapStart: function(e) {
    if (!!e.cancelable) {
      ...
      if (To(a), !A && !(/mousedown|pointerdown/.test(t) && e.button !== 0 || n.disabled) && !l.isContentEditable && !(!this.nativeDraggable && je && i && i.tagName.toUpperCase() === "SELECT") && (i = Vt(i, n.draggable, a, !1), !(i && i.animated) && tn !== i)) {
  ...
  _emulateDragOver: function() {
    if (Kt) {
      this._lastX = Kt.clientX, this._lastY = Kt.clientY, gr();
  ...
  _onDragOver: function(e) {
    ...
    if (ln = !1, l && !o.disabled && (f ? c || (t = ct !== at) : Ot === this || (this.lastPutMode = Ye.checkPull(this, l, A, e)) && i.checkPut(this, l, A, e))) {
      ...
      if (!x || Eo(e, v, this) && !x.animated) {
        ...
        if (G !== !1)
          return (G === 1 || G === -1) && (M = G === 1), Dn = !0, setTimeout(So, 30), S(), M && !W ? r.appendChild(A) : a.parentNode.insertBefore(A, M ? W : a), j && dr(j, 0, X - j.scrollTop), ct = A.parentNode, w !== void 0 && !ze && (en = Math.abs(w - it(a)[N])), T(), b(!0);
      }
      if (r.contains(A))
        return b(!1);
    }
  ...
  option: function(e, r) {
    ...
    typeof n < "u" ? a[e] = n : a[e] = r, e === "group" && pr(a);
  },
  destroy: function() {
    At("destroy", this);
    var e = this.el;
...
function Co() {
  ...
  return s.prototype = {
    ...
    drop: function() {
      this.sortable.nativeDraggable ? Q(document, "dragover", this._handleAutoScroll) : (Q(document, "pointermove", this._handleFallbackAutoScroll), Q(document, "touchmove", this._handleFallbackAutoScroll), Q(document, "mousemove", this._handleFallbackAutoScroll)), Qn(), rn(), lo();
    },
    nulling: function() {
  ...
  if (!!e.scroll) {
    ...
    do {
      ...
      (gt[c].vx != X || gt[c].vy != D || gt[c].el !== v) && (gt[c].el = v, gt[c].vx = X, gt[c].vy = D, clearInterval(gt[c].pid), (X != 0 || D != 0) && (l = !0, gt[c].pid = setInterval(function() {
        ...
        typeof f == "function" && f.call(B.dragged.parentNode[Tt], M, W, s, cn, gt[this.layer].el) !== "continue" || dr(gt[this.layer].el, M, W);
      }.bind({
        layer: c
      }), 24))), c++;
...
const No = /* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
  ...
  Sortable: B,
  Swap: Po
}, Symbol.toStringTag, { value: "Module" })), Mo = /* @__PURE__ */ ir(No);
(function(s, e) {
  (function(a, n) {
    s.exports = n(Jr, Mo);
          ...
          o({ target: "JSON", stat: !0, forced: ht }, {
            stringify: function(U, K, k) {
              ...
              if (gn = K, !(!S(K) && U === void 0 || y(U)))
                return g(K) || (K = function(br, Xe) {
                  if (typeof gn == "function" && (Xe = gn.call(this, br, Xe)), !y(Xe))
                    return Xe;
...
const Sr = /* @__PURE__ */ zr(sr.exports), jo = { class: "k-component-view" }, Fo = { class: "collapse-header" }, wo = { class: "source-componet-item" }, Lo = /* @__PURE__ */ Zt({
    ...
    return (t, o) => {
      ...
      return mt(), pe(_(Sr), {
        ...
        item: Jt(({ element: l }) => {
          ...
          return [
            Lt("div", {
              class: tr(["item", { checked: ((f = _(a).state.checkedNode) == null ? void 0 : f.id) === l.id }]),
              onClick: Ar((d) => _(a).setCheckedNode(l), ["stop"])
            }, [
              er(Lt("div", Vo, [
                Lt("div", Ho, Be(l.type), 1)
              ], 512), [
                [nr, ((c = _(a).state.checkedNode) == null ? void 0 : c.id) === l.id]
              ]),
              Nt(_(or), { record: l }, {
                "edit-node": Jt((d) => [
                  Nt(i, {
